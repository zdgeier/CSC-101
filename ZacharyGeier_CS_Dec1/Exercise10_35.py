...
class BounceBalls:
    def __init__(self):
        ...
        btSpeedUp = Button(frame, text='Faster', command = self.speedUp)
        btSpeedUp.pack(side = LEFT)
        btSlowDown = Button(frame, text='Slower', command = self.slowDown)
        btSlowDown.pack(side = LEFT)
